...
<head>
    ...
    <style>
        ...
        * {
        ...
        table th {
            background-color: #2c3e50; /* Warna header tabel disesuaikan dengan background dashboard */
            color: #fff;
            text-transform: uppercase;
            font-weight: bold;
        ...
        table td {
            ...
            border: 1px solid #dee2e6;
            font-weight: bold;
            color: #1abc9c; /* Warna teks isi tabel */
        }
...
<body>
    ...
    <div class="table-container">
        <h2>Data Lembur</h2>
        <a href="/lembur/tambah" class="btn-add">+ Tambah lemburan Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID Lembur</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="{{ route('lembur.edit', $p->lembur_id) }}" class="btn-edit">Edit</a>
                        
                        <a href="{{ route('lembur.delete', $p->lembur_id) }}" class="btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
