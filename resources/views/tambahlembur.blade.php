...
<body>
    ...
    <div class="form-container">
        ...
        <h2>Tambah Lembur Baru</h2>
        <form action="/lembur/store" method="post">
            {{ csrf_field() }}
            <label for="id_pegawai">ID Pegawai:</label>
            <input type="text" id="id_pegawai" name="id_pegawai" required="required">

            <label for="bulan_lembur">Bulan Lembur:</label>
            <input type="text" id="bulan_lembur" name="bulan_lembur" required="required">
